...
const SECTIONS = [
  {
    ...
    body: `Al acceder, registrarte o usar Lucebase (en adelante "la Plataforma"), aceptas estos Términos y Condiciones en su totalidad y sin reservas. Si no estás de acuerdo con alguna parte, debes abstenerte de usar la Plataforma. Lucebase se reserva el derecho de modificar estos términos en cualquier momento; los cambios entran en vigor al momento de su publicación. El uso continuado de la Plataforma tras cualquier modificación constituye tu aceptación de los nuevos términos.`,
  },
  {
    title: "2. Descripción del servicio",
    body: `Lucebase es una plataforma digital de mercados de predicción con fines de entretenimiento, operada bajo las leyes de los Estados Unidos Mexicanos. Los usuarios pueden adquirir posiciones en eventos verificables de carácter público (política, deportes, finanzas, entretenimiento, tecnología) utilizando saldo en pesos mexicanos (MXN). Lucebase no es una casa de apuestas deportivas, no está regulada por la Secretaría de Gobernación bajo la Ley Federal de Juegos y Sorteos, y no ofrece servicios financieros regulados. El saldo en la Plataforma es un medio de acceso al servicio de entretenimiento, no un instrumento de inversión.`,
  },
  {
    title: "3. Elegibilidad",
    body: `Para usar Lucebase debes: (a) tener al menos 18 años de edad cumplidos; (b) ser persona física con capacidad legal para contratar; (c) residir en una jurisdicción donde el uso de esta Plataforma sea legal. Al crear una cuenta declaras bajo protesta de decir verdad que cumples todos estos requisitos. Lucebase se reserva el derecho de solicitar documentos de identificación en cualquier momento y de suspender o cancelar cuentas que no cumplan estos criterios, sin responsabilidad de devolución del saldo en casos de fraude comprobado.`,
  },
  {
    title: "4. Registro y seguridad de la cuenta",
    body: `Al registrarte proporcionas información veraz, completa y actualizada. Eres el único responsable de mantener la confidencialidad de tus credenciales de acceso y de todas las actividades realizadas desde tu cuenta. Debes notificar a Lucebase de inmediato ante cualquier uso no autorizado enviando un correo a contacto@lucebase.mx. Está prohibido transferir, vender o ceder tu cuenta a terceros. Lucebase no se responsabiliza por pérdidas derivadas del acceso no autorizado a tu cuenta por causas imputables al usuario.`,
  },
  {
    title: "5. Depósitos",
    body: `Los depósitos se procesan a través de Conekta, procesador de pagos certificado conforme a la normativa mexicana. Aceptamos tarjeta de crédito/débito (Visa, Mastercard, American Express), pagos en efectivo vía OXXO Pay y transferencias SPEI. El monto mínimo de depósito es de $100 MXN. Los fondos se acreditan en tu saldo de Lucebase una vez confirmado el pago por Conekta, lo cual puede tomar entre minutos (tarjeta/SPEI) y 24 horas (OXXO). Lucebase no almacena datos de tarjetas bancarias.`,
  },
  {
    title: "6. Retiros",
    body: `Los retiros de saldo están disponibles para usuarios con cuenta verificada. El monto mínimo de retiro es de $200 MXN. Las solicitudes se procesan en 1 a 5 días hábiles mediante transferencia bancaria SPEI a la cuenta registrada a nombre del titular. Lucebase puede solicitar documentos de verificación de identidad (INE/pasaporte) antes de procesar el primer retiro o ante movimientos inusuales. El retiro de fondos producto de actividad fraudulenta está prohibido y puede resultar en acciones legales.`,
  },
  {
    title: "7. Comisiones y tarifas",
    body: `Lucebase aplica una comisión de plataforma del 3% sobre el monto neto pagado a los ganadores de cada mercado. Esta comisión se deduce automáticamente al momento de la resolución del mercado. No se cobran comisiones por depósito. Los retiros son gratuitos. Las tarifas de procesamiento de Conekta (cuando apliquen) corren por cuenta de Lucebase y no se trasladan al usuario. Lucebase se reserva el derecho de modificar su estructura de comisiones con aviso previo de 15 días naturales.`,
  },
  {
    title: "8. Resolución de mercados",
    body: `Los mercados se resuelven por el equipo editorial de Lucebase utilizando fuentes públicas, verificables e independientes (medios de comunicación reconocidos, fuentes oficiales, registros públicos). El resultado se publica junto con la fuente de verificación. Si un evento no puede verificarse de forma concluyente dentro del plazo establecido, el mercado se declara nulo y se reembolsa íntegramente el saldo apostado a todos los participantes sin deducción alguna. La resolución del equipo editorial es definitiva e inapelable.`,
  },
  {
  ...
  {
    title: "15. Contacto",
    body: `Para cualquier pregunta, duda o reclamación relacionada con estos Términos y Condiciones, contáctanos en: contacto@lucebase.mx. Tiempo de respuesta: máximo 5 días hábiles.`,
  },
];
    ...
    <div className="max-w-2xl mx-auto space-y-8 pb-12">
      ...
      <div className="p-4 rounded-xl bg-blue-50 dark:bg-blue-950/20 border border-blue-200/60 dark:border-blue-900/40">
        <p className="text-[12.5px] text-blue-700 dark:text-blue-300 leading-relaxed">
          Lee estos términos detenidamente antes de usar la plataforma. Al registrarte o usar Lucebase aceptas quedar vinculado por estas condiciones en su totalidad.
        </p>
      </div>
      ...
      <p className="text-[12px] text-gray-400 text-center">
        ¿Tienes preguntas?{" "}
        <a href="mailto:contacto@lucebase.mx" className="text-blue-600 hover:underline font-medium">
